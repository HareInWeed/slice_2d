            ...
            unsafe {
                Some([
                    Slice2DMut::from_raw_parts(
                        self.get_slice_ptr_mut(),
                        self.get_base_col(),
                        self.get_row(),
                        j,
                    ),
                    Slice2DMut::from_raw_parts(
                        self.get_slice_ptr_mut().add(calc_2d_index(0, j, self)),
                        self.get_base_col(),
                        self.get_row(),
                        self.get_col() - j,
                    ),
        ...
        if i < self.get_row() {
            unsafe {
                Some([
                    ...
                    Slice2DMut::from_raw_parts(
                        self.get_slice_ptr_mut().add(calc_2d_index(i, 0, self)),
                        self.get_base_col(),
                        self.get_row() - i,
                        self.get_col(),
                    ),
            ...
            unsafe {
                Some([
                    ...
                    [
                        ...
                        Slice2DMut::from_raw_parts(
                            self.get_slice_ptr_mut().add(calc_2d_index(i, j, self)),
                            self.get_base_col(),
                            self.get_row() - i,
                            self.get_col() - j,
                        ),
